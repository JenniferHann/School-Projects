...
public class Note {
    ...
    /**
     * Create a blank notes with a specific ID.
     * @param id
     */
    public Note(long id) {
        this.id = id;
     ...
     * @param modified
     */
    public Note(long id, String uuid, String title, String body, Category category, boolean hasReminder, Date reminder, Date created, Date modified) {
        this(id);
        this.uuid = uuid;
        this.title = title;
        this.body = body;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, uuid, title, body, category, hasReminder, reminder, created, modified);
    }

    /**
     * Create a duplicate (aka clone) of the notes.
     * @return
     */
    public Note clone() {
        Note clone = new Note();

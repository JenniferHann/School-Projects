...
namespace Budget
{
    ...
    public class CategoriesManager
    {
        ...
        {
            Category c = _Cats.Find(x => x.Id == CategoryID);
            if (c == null)
            {
                throw new Exception("Cannot find category with id " + CategoryID.ToString());
            }
            return c;
        }
        ...
        {
            List<Category> newList = new List<Category>(_Cats);
            return newList;
        }
        ...
        private void _WriteXMLFile(String filepath)
        {
            try
            {
                ...
                XmlDocument doc = new XmlDocument();
                doc.LoadXml("<CategoriesManager></CategoriesManager>");

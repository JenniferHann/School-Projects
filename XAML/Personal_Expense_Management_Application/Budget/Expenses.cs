...
namespace Budget
{
    ...
    public class Expenses
    {
        ...
        // Modify expense
        // ====================================================================
        public void Modify(int Id, DateTime date, int category, Double amount, String description)
        {
            Expense e = Get(Id);
        ...
        {
            Expense e = _Expenses.Find(x => x.Id == ExpenseId);
            return e;
        }
        ...
        {
            List<Expense> newList = new List<Expense>(_Expenses);
            return newList;
        }

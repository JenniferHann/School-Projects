...
namespace NoNameBikes.Models
{
    public partial class AdventureWorksLT2017Context : DbContext
    {
        ...
        public virtual DbSet<PasswordRecoveryToken> PasswordRecoveryToken { get; set; }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer("Server=10.101.0.12\\SQLEXPRESS;Database=AdventureWorksLT2017;User ID=Student516;Password=SecretSauce2020");
            }
        }

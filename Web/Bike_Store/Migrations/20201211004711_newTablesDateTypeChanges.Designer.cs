...
namespace NoNameBikes.Migrations
{
    ...
    [Migration("20201211004711_newTablesDateTypeChanges")]
    partial class newTablesDateTypeChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoNameBikes.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.BuildVersion", b =>
                {
                    ...
                    b.HasComment("Current version number of the AdventureWorksLT 2012 sample database. ");
                });

            modelBuilder.Entity("NoNameBikes.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnName("CustomerID")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NoNameBikes.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.LogIn", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.PasswordRecoveryToken", b =>
                {
                    ...
                    b.ToTable("PasswordRecoveryToken");
                });

            modelBuilder.Entity("NoNameBikes.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductCategoryID")
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnName("ProductModelID")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NoNameBikes.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("NoNameBikes.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SalesOrderID")
            ...
            modelBuilder.Entity("NoNameBikes.Models.CustomerAddress", b =>
                {
                    b.HasOne("NoNameBikes.Models.Address", "Address")
                        .WithMany("CustomerAddress")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("NoNameBikes.Models.Customer", "Customer")
                        .WithMany("CustomerAddress")
            ...
            modelBuilder.Entity("NoNameBikes.Models.Product", b =>
                {
                    b.HasOne("NoNameBikes.Models.ProductCategory", "ProductCategory")
                        .WithMany("Product")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("NoNameBikes.Models.ProductModel", "ProductModel")
                        .WithMany("Product")
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductCategory", b =>
                {
                    b.HasOne("NoNameBikes.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("NoNameBikes.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("NoNameBikes.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("NoNameBikes.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("NoNameBikes.Models.Product", "Product")
                        .WithMany("SalesOrderDetail")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("NoNameBikes.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetail")
            ...
            modelBuilder.Entity("NoNameBikes.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("NoNameBikes.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("NoNameBikes.Models.Address", "ShipToAddress")
